...
## API Endpoints
The application provides a REST API endpoint for the **sum** operation.
...
- **Response**:
  ...
  ```
- **Error Handling**:
  - If either `a` or `b` is missing or not an integer, the API will return a `400 Bad Request` response.
