...
## Features
The application provides a REST API for basic arithmetic operations. Currently, it supports the following operation:
- **Addition**: Add two numbers via a REST endpoint.
...
## Testing
The application includes unit tests for arithmetic logic and integration tests for the API. To run the tests, use:
```bash
mvn test
```
...
## Future Enhancements
The application can be extended to support additional arithmetic operations such as:
- Subtraction
- Multiplication
- Division
