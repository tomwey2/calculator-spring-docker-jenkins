...
| **HTTP Method** | **Endpoint** | **Description**                     |
|----------------|-------------|-------------------------------------|
| GET            | `/subtract` | Subtracts two integers and returns the result. |
...
| **HTTP Method** | **Endpoint** | **Description**                     |
|----------------|-------------|-------------------------------------|
| GET            | `/multiply` | Multiplies two integers and returns the result. |
...
| **HTTP Method** | **Endpoint** | **Description**                     |
|----------------|-------------|-------------------------------------|
| GET            | `/divide`   | Divides two integers and returns the result. |
