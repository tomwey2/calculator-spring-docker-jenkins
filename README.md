...
| Endpoint | Method | Description | Parameters | Example Request | Response |
|----------|--------|-------------|------------|------------------|----------|
| `/sum`   | GET    | Adds two integers and returns the result. | `a` (integer), `b` (integer) | `curl "http://localhost:8080/sum?a=5&b=3"` | `8` |

### Error Responses
- **Invalid Parameters**: If either `a` or `b` is not an integer, the API will return a `400 Bad Request` error.
...
| Endpoint | Method | Description | Parameters | Example Request | Response |
|----------|--------|-------------|------------|------------------|----------|
| `/subtract` | GET | Subtracts two integers and returns the result. | `a` (integer), `b` (integer) | `curl "http://localhost:8080/subtract?a=5&b=3"` | `2` |
| `/multiply` | GET | Multiplies two integers and returns the result. | `a` (integer), `b` (integer) | `curl "http://localhost:8080/multiply?a=5&b=3"` | `15` |
| `/divide` | GET | Divides two integers and returns the result. | `a` (integer), `b` (integer) | `curl "http://localhost:8080/divide?a=6&b=3"` | `2` |
