...
### Overview
The application provides REST API endpoints for basic arithmetic operations. Below is a summary of the available endpoints:

| Endpoint | Method | Description | Parameters |
|----------|--------|-------------|------------|
| `/sum` | GET | Adds two integers and returns the result | `a` (integer), `b` (integer) |
...
- **Response**:
  ...
  ```
- **Error Handling**:
  - If either `a` or `b` is missing or invalid, the API will return a `400 Bad Request` error.
